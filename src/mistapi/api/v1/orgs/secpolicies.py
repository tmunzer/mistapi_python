...
def listOrgSecPolicies(mist_session:_APISession, org_id:str, limit:int=100, page:int=1) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def createOrgSecPolicy(mist_session:_APISession, org_id:str, body:object) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def getOrgSecPolicy(mist_session:_APISession, org_id:str, secpolicy_id:str) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def deleteOrgSecPolicy(mist_session:_APISession, org_id:str, secpolicy_id:str) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def updateOrgSecPolicy(mist_session:_APISession, org_id:str, secpolicy_id:str, body:object) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
