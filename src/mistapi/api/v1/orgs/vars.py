...
def searchOrgVars(mist_session:_APISession, org_id:str, site_id:str=None, var:str=None, src:str=None, limit:int=100, page:int=1) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
