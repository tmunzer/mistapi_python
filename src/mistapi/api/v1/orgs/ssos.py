...
def updateOrgSso(
    mist_session: _APISession, org_id: str, sso_id: str, body: dict
) -> _APIResponse:
    """
...
def deleteOrgSsoAdmins(
    mist_session: _APISession, org_id: str, sso_id: str, body: dict | list
) -> _APIResponse:
    """
    API doc: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/orgs/sso/delete-org-sso-admins
    ...
    uri = f"/api/v1/orgs/{org_id}/ssos/{sso_id}/delete_admins"
    resp = mist_session.mist_post(uri=uri, body=body)
    return resp


def listOrgSsoLatestFailures(
    mist_session: _APISession,
    org_id: str,
    sso_id: str,
    start: str | None = None,
...
def getOrgSamlMetadata(
    mist_session: _APISession, org_id: str, sso_id: str
) -> _APIResponse:
    """
