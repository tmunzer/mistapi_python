...
@deprecation.deprecated(deprecated_in="0.37.7", removed_in="0.52.0", current_version="0.45.1", details="function replaced with listOrgAlarmTemplates")  
...
@deprecation.deprecated(deprecated_in="0.37.7", removed_in="0.52.0", current_version="0.45.1", details="function replaced with listOrgSuppressedAlarms")  
