...
def createOrgRfTemplate(mist_session:_APISession, org_id:str, body:dict) -> _APIResponse:
    """
...
def updateOrgRfTemplate(mist_session:_APISession, org_id:str, rftemplate_id:str, body:dict) -> _APIResponse:
    """
