...
def createOrgGatewayTemplate(mist_session:_APISession, org_id:str, body:dict) -> _APIResponse:
    """
...
def updateOrgGatewayTemplate(mist_session:_APISession, org_id:str, gatewaytemplate_id:str, body:dict) -> _APIResponse:
    """
