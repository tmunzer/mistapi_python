...
@deprecation.deprecated(deprecated_in="0.37.7", removed_in="0.52.0", current_version="0.46.3", details="function replaced with listOrgMxEdges")  
...
@deprecation.deprecated(deprecated_in="0.37.7", removed_in="0.52.0", current_version="0.46.3", details="function replaced with listOrgMxEdgeUpgrades")  
