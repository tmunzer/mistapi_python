...
def deleteMspSsoRole(
    mist_session: _APISession, msp_id: str, ssorole_id: str
) -> _APIResponse:
    """
...
def updateMspSsoRole(
    mist_session: _APISession, msp_id: str, ssorole_id: str, body: dict
) -> _APIResponse:
    """
