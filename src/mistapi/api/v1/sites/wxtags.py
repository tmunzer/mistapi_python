...
def getSiteWxTags(mist_session:_APISession, site_id:str) -> Response:
    """
...
def createSiteWxTag(mist_session:_APISession, site_id:str, body:object) -> Response:
    """
...
def getSiteApplicationList(mist_session:_APISession, site_id:str) -> Response:
    """
...
def getSiteWxTag(mist_session:_APISession, site_id:str, wxtag_id:str) -> Response:
    """
...
def deleteSiteWxTag(mist_session:_APISession, site_id:str, wxtag_id:str) -> Response:
    """
...
def updateSiteWxTag(mist_session:_APISession, site_id:str, wxtag_id:str, body:object) -> Response:
    """
...
def getSiteCurrentMatchingClientsOfAWxTag(mist_session:_APISession, site_id:str, wxtag_id:str) -> Response:
    """
