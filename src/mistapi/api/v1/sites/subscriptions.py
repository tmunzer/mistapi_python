...
def UnsubscribeSiteAlarms(mist_session:_APISession, site_id:str) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def SubscribeSiteAlarms(mist_session:_APISession, site_id:str) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
