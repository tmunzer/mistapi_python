...
def overwriteSiteMlForDevice(mist_session:_APISession, site_id:str, device_id:str, body:dict) -> _APIResponse:
    """
...
def overwriteSiteMlForMap(mist_session:_APISession, site_id:str, map_id:str, body:dict) -> _APIResponse:
    """
