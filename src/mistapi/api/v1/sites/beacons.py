...
def createSiteBeacon(mist_session:_APISession, site_id:str, body:dict) -> _APIResponse:
    """
...
def updateSiteBeacon(mist_session:_APISession, site_id:str, beacon_id:str, body:dict) -> _APIResponse:
    """
