...
def importSiteMapsFile(mist_session:_APISession, site_id:str, auto_deviceprofile_assignment:bool|None=None, csv:str|None=None, file:str|None=None, json:dict|None=None) -> _APIResponse:
    """
...
def updateSiteMap(mist_session:_APISession, site_id:str, map_id:str, body:dict) -> _APIResponse:
    """
...
def startSiteApAutoOrientation(mist_session:_APISession, map_id:str, site_id:str, body:dict) -> _APIResponse:
    """
...
def runSiteApAutoplacement(mist_session:_APISession, site_id:str, map_id:str, body:dict) -> _APIResponse:
    """
...
def clearSiteApAutoOrient(mist_session:_APISession, site_id:str, map_id:str, body:dict) -> _APIResponse:
    """
...
def clearSiteApAutoplacement(mist_session:_APISession, site_id:str, map_id:str, body:dict) -> _APIResponse:
    """
...
def addSiteMapImageFile(mist_session:_APISession, site_id:str, map_id:str, file:str|None=None, json:str|None=None) -> _APIResponse:
    """
...
def replaceSiteMapImageFile(mist_session:_APISession, site_id:str, map_id:str, file:str|None=None, json:dict|None=None) -> _APIResponse:
    """
...
def bulkAssignSiteApsToMap(mist_session:_APISession, site_id:str, map_id:str, body:dict) -> _APIResponse:
    """
...
def confirmSiteApLocalizationData(mist_session:_APISession, site_id:str, map_id:str, body:dict) -> _APIResponse:
    """
...
def importSiteWayfindings(mist_session:_APISession, site_id:str, map_id:str, body:dict) -> _APIResponse:
    """
