...
def deleteSiteAssetImage(
    mist_session: _APISession, site_id: str, asset_id: str
) -> _APIResponse:
    """
    API doc: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/sites/assets/delete-site-asset-image
    ...
    uri = f"/api/v1/sites/{site_id}/assets/{asset_id}/image"
    query_params: dict[str, str] = {}
    resp = mist_session.mist_delete(uri=uri, query=query_params)
    return resp


def attachSiteAssetImageFile(
    mist_session: _APISession,
    site_id: str,
    asset_id: str,
    file: str | None = None,
    ...
    """
    API doc: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/sites/assets/attach-site-asset-image
