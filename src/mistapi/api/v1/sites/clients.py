...
def countSiteWirelessClientEvents(
    mist_session: _APISession,
    site_id: str,
...
def searchSiteWirelessClientEvents(
    mist_session: _APISession,
    site_id: str,
    type: str | None = None,
    reason_code: int | None = None,
...
def countSiteWirelessClientSessions(
    mist_session: _APISession,
    site_id: str,
    distinct: str = "mac",
    ap: str | None = None,
...
def reauthSiteDot1xWirelessClient(
...
def disconnectSiteWirelessClient(
    mist_session: _APISession, site_id: str, client_mac: str
) -> _APIResponse:
    """
...
def unauthorizeSiteWirelessClient(
    mist_session: _APISession, site_id: str, client_mac: str
) -> _APIResponse:
    """
