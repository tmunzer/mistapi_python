...
def getSiteInsightMetricsForClient(mist_session:_APISession, site_id:str, client_mac:str, metric:str, start:int=None, end:int=None, duration:str="1d", interval:str=None, limit:int=100, page:int=1) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def getSiteInsightMetricsForDevice(mist_session:_APISession, site_id:str, metric:str, device_mac:str, start:int=None, end:int=None, duration:str="1d", interval:str=None, limit:int=100, page:int=1) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def countOrgClientFingerprints(mist_session:_APISession, site_id:str, distinct:str="family", start:int=None, end:int=None, duration:str="1d", limit:int=100) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def searchOrgClientFingerprints(mist_session:_APISession, site_id:str, family:str=None, client_type:str=None, model:str=None, mfg:str=None, os:str=None, os_type:str=None, mac:str=None, sort:str=None, limit:int=100, start:int=None, end:int=None, duration:str="1d", interval:str=None) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def listSiteRogueAPs(mist_session:_APISession, site_id:str, type:str=None, limit:int=100, start:int=None, end:int=None, duration:str="1d", interval:str=None) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def listSiteRogueClients(mist_session:_APISession, site_id:str, limit:int=100, start:int=None, end:int=None, duration:str="1d", interval:str=None) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
...
@sync_async_compatible
def getSiteInsightMetrics(mist_session:_APISession, site_id:str, metric:str, start:int=None, end:int=None, duration:str="1d", interval:str=None, limit:int=100, page:int=1) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
