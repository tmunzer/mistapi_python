...
def createSiteVBeacon(mist_session:_APISession, site_id:str, body:dict) -> _APIResponse:
    """
...
def updateSiteVBeacon(mist_session:_APISession, site_id:str, vbeacon_id:str, body:dict) -> _APIResponse:
    """
