...
def createSiteWebhook(mist_session:_APISession, site_id:str, body:dict) -> _APIResponse:
    """
...
def updateSiteWebhook(mist_session:_APISession, site_id:str, webhook_id:str, body:dict) -> _APIResponse:
    """
