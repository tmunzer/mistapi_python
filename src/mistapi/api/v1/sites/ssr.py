...
def getSiteSsrUpgrade(mist_session:_APISession, site_id:str, upgrade_id:str) -> Response:
    """
...
def upgradeSiteSsr(mist_session:_APISession, site_id:str, device_id:str, body:object) -> Response:
    """
