...
def searchSiteZoneSessions(mist_session:_APISession, site_id:str, zone_type:str, user_type:str=None, user:str=None, scope_id:str=None, scope:str="site", start:int=None, end:int=None, duration:str="1d", limit:int=100, page:int=1) -> Union[_APIResponse, Awaitable[_APIResponse]]:
    """
