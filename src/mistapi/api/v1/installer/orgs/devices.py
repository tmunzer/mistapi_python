...
@deprecation.deprecated(deprecated_in="0.37.7", removed_in="0.60.0", current_version="0.44.0", details="function replaced with listInstallerListOfRenctlyClaimedDevices")  
