...
def get_by_id(mist_session:Session, org_id, wlan_id):
    uri = f"/api/v1/orgs/{org_id}/wlans/{wlan_id}" 
    resp = mist_session.mist_get(uri)
    return resp

def create(mist_session:Session, org_id, wlan_settings):
    uri = f"/api/v1/orgs/{org_id}/wlans" 
    resp = mist_session.mist_post(uri, body=wlan_settings)
    return resp

def delete(mist_session:Session, org_id, wlan_id):
    uri = f"/api/v1/orgs/{org_id}/wlans/{wlan_id}" 
    resp = mist_session.mist_delete(uri)
    return resp

def add_portal_image(mist_session:Session, org_id, wlan_id, image_path):
...
def delete_portal_image(mist_session:Session, org_id, wlan_id):
    uri = f"/api/v1/orgs/{org_id}/wlans/{wlan_id}/portal_image" 
    resp = mist_session.mist_delete(uri)
    return resp

def set_portal_template(mist_session:Session, org_id, wlan_id, portal_template_body):
...
def report(mist_session:Session, org_id, fields):
