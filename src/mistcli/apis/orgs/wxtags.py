...
def create(mist_session:Session, org_id, wxtag_settings):
    uri = f"/api/v1/orgs/{org_id}/wxtags" 
    body = wxtag_settings
    resp = mist_session.mist_post(uri, body=body)
    return resp

def update(mist_session:Session, org_id, wxtag_id, body={}):
    uri = f"/api/v1/orgs/{org_id}/wxtags/{wxtag_id}" 
    resp = mist_session.mist_put(uri, body=body)
    return resp
    
def delete(mist_session:Session, org_id, wxtag_id):
    uri = f"/api/v1/orgs/{org_id}/wxtags/{wxtag_id}" 
...
def get_by_id(mist_session:Session, org_id, wxtag_id):
    uri = f"/api/v1/orgs/{org_id}/wxtags/{wxtag_id}" 
